    ...
    if (cardsOpen.length <= 1) {
      ...
      if (cardsOpen[0] == cardsOpen[1]) {
        ...
        $("[open1]")
          .delay(1000)
          .replaceWith(
            `<div card class="card" id="${cardsOpen2[0]}"><img src="/jogo_da_memoria_aves_marinhas/assets/logoTropibio.png" alt="card" width="100px" height="100px"></div>`
          );
        $("[open2]")
          .delay(1000)
          .replaceWith(
            `<div card class="card" id="${cardsOpen2[1]}"><img src="/jogo_da_memoria_aves_marinhas/assets/logoTropibio.png" alt="card" width="100px" height="100px"></div>`
          );
        cardsOpen = cardsNone;
